...
{
  char tmp1[40],tmp2[40],tmp3[40],tmp4[40],tmp5[40],tmp6[40],tmp7[40],tmp8[40],tmp9[40],tmp10[40],tmp11[40],tmp12[40],tmp13[40],tmp14[40];
  FILE* f;
	  ...
	  for(Int_t binz=0;binz<NUMz;binz++)
	    {
	      ...
	      nbr_depolU[binq][binx][binz]+=atof(tmp13);
	      nbr_depolD[binq][binx][binz]+=atof(tmp14);
	    }
      fclose(f);
    }
  flist.close();
...
void write_file()
{
  ...
  for(Int_t binq=0;binq<NUMq2;binq++)
    for(Int_t binx=0;binx<NUMxb;binx++)
      for(Int_t binz=0;binz<NUMz;binz++)
        fprintf(f, "%f %f %f %f %f %f %f %f %f %f %f %f %f %f \n",nbr_hadU[binq][binx][binz],nbr_hadU_err[binq][binx][binz],nbr_hadD[binq][binx][binz],nbr_hadD_err[binq][binx][binz],nbr_q2U[binq][binx][binz],nbr_q2D[binq][binx][binz],nbr_xbU[binq][binx][binz],nbr_xbD[binq][binx][binz],nbr_zU[binq][binx][binz],nbr_zD[binq][binx][binz],nbr_yU[binq][binx][binz],nbr_yD[binq][binx][binz],nbr_depolU[binq][binx][binz],nbr_depolD[binq][binx][binz]);
  fclose(f);
}
