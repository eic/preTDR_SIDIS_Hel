...
void plot_asymPubwithout(Int_t const id,char const * enn)
{
  pid=id;
...
void write_out()
{
  ...
  if(pid==211)
    snprintf(FileName,100,"output_asym/withoutdepol/asym_%s_pionspos.out",en);
  else if(pid==-211)
    snprintf(FileName,100,"output_asym/withoutdepol/asym_%s_pionsneg.out",en);
  else if(pid==321)
    snprintf(FileName,100,"output_asym/withoutdepol/asym_%s_kaonspos.out",en);
  else if(pid==-321)
    snprintf(FileName,100,"output_asym/withoutdepol/asym_%s_kaonsneg.out",en);
  else
    {
...
void plot_graph()
{
  ...
  snprintf(plot_name,100,"output_plots/withoutdepol/asym_%s_%s%s.eps",en,charge,part_id);
  ...
  snprintf(plot_name_pdf,200,"output_plots/withoutdepol/asymPub_%s_%s%s.pdf",en,charge,part_id);
...
void get_input()
{
  ...
  snprintf(inFileName,100,"output/withoutdepol/scaledhad_%s_%s%s.out",en,part_id,charge);
  snprintf(inmcFileName,100,"output/withoutdepol/scaledmc_had_%s_%s%s.out",en,part_id,charge);
